...
public class AdminEditCourse extends javax.swing.JFrame {
    ...
    public int subjectId = AdminUI.subjectId;
    ...
    private void submitInfoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitInfoButtonActionPerformed
        ...
        DataHandler.Students.availableSubjects.get(subjectId).setSubjectCode(courseCode);
        DataHandler.Students.availableSubjects.get(subjectId).setName(courseName);
        DataHandler.Students.availableSubjects.get(subjectId).setTeacher(teacherName);
        DataHandler.Students.availableSubjects.get(subjectId).setStart(LocalTime.of(startHour, startMinutes));
        DataHandler.Students.availableSubjects.get(subjectId).setEnd(LocalTime.of(endHour, endMinutes));
    ...
    public void initializeCourseInfo(){
        courseCodeField.setText(DataHandler.Students.availableSubjects.get(subjectId).getSubjectCode());
        courseNameField.setText(DataHandler.Students.availableSubjects.get(subjectId).getName());
        teacherNameField.setText(DataHandler.Students.availableSubjects.get(subjectId).getTeacher());
        
        startHourChoice.setSelectedIndex(DataHandler.Students.availableSubjects.get(subjectId).getStart().getHour());
        startMinutesChoice.setSelectedIndex(DataHandler.Students.availableSubjects.get(subjectId).getStart().getMinute());
        endHourChoice.setSelectedIndex(DataHandler.Students.availableSubjects.get(subjectId).getEnd().getHour());
        endMinutesChoice.setSelectedIndex(DataHandler.Students.availableSubjects.get(subjectId).getEnd().getMinute());
    }
